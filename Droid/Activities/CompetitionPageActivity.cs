...
namespace Versus.Droid
{
    ...
    public class CompetitionPageActivity : Activity
    {
        ...
        protected async override void OnCreate (Bundle savedInstanceState)
        {
            ...
            if (competition != null) {
                ...
                if (entity1 != null && entity2 != null) {
                    ...
                    votingButton.Click += (object sender, EventArgs e) => {
                        var index = 1;
                        if (_selectedEntity == entity1) {
                            index = 1;
                        } else {
                            index = 2;
                        }
                ...
                e1ImageButton.Click+= (object sender, EventArgs e) => {
                    _selectedEntity = entity1;
                    UpdateUiForSelectedEntity (entityName, entityDescription, votingButton);
                };

                e2ImageButton.Click += (object sender, EventArgs e) => {
        ...
        void UpdateUiForSelectedEntity (TextView entityName, TextView entityDescription, Button votingButton)
        {
